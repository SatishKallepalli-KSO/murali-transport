...
const dict = {
  en: {
    ...
    adminIntro: 'Staff-only desk. Receive load requests, review nearby lorries, and assign trips.',
    adminPin: 'Admin PIN',
    adminStaffNote: 'Bookmark the staff link (…/#desk). Public visitors do not see Admin in the menu.',
  ...
  te: {
    ...
    adminIntro: 'సిబ్బంది డెస్క్ మాత్రమే. లోడ్ అభ్యర్థనలు అందుకొని, సమీప లారీలను చూసి ట్రిప్‌లు కేటాయించండి.',
    adminPin: 'అడ్మిన్ PIN',
    adminStaffNote: 'సిబ్బంది లింక్ బుక్‌మార్క్ చేయండి (…/#desk). సాధారణ సందర్శకులకు అడ్మిన్ మెనూలో కనిపించదు.',
