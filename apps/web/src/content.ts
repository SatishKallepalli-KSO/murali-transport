...
const dict = {
  en: {
    ...
    callNow: 'Call now',
    whatsapp: 'WhatsApp',
    heroKicker: 'Dommeru office · Andhra Pradesh',
    heroBrand: 'Murali Transport Office',
    heroSub: 'Reliable mini lorry & truck booking',
    heroTagline:
      'From Dommeru we arrange cargo to major hubs — clear matching, local coordination, one office you can call.',
    ...
    whyIntro: 'A Dommeru office built for clear bookings — not a faceless marketplace.',
    why1Title: 'Local office desk',
    why1Body: 'Speak with the Dommeru office for booking help, not an anonymous listing board.',
    why2Title: 'Location-aware matching',
    why2Body: 'We match open loads to lorries near the pickup for faster dispatch.',
    why3Title: 'Clear communication',
    why3Body: 'Pickup, drop, cargo, and contacts stay with the office until the trip is assigned.',
    why4Title: 'Owners & shippers together',
    why4Body: 'Post a load or register a lorry — one desk coordinates both sides.',
    serviceLearn: 'Start here',
  ...
  te: {
    ...
    callNow: 'కాల్ చేయండి',
    whatsapp: 'వాట్సాప్',
    heroKicker: 'దొమ్మేరు ఆఫీస్ · ఆంధ్రప్రదేశ్',
    heroBrand: 'మురళి ట్రాన్స్‌పోర్ట్ ఆఫీస్',
    heroSub: 'నమ్మకమైన మినీ లారీ & ట్రక్ బుకింగ్',
    heroTagline:
      'దొమ్మేరు నుండి ప్రధాన హబ్‌లకు సరుకు ఏర్పాటు — స్పష్టమైన మ్యాచింగ్, స్థానిక సమన్వయం, ఒకే ఆఫీస్‌కు కాల్.',
    ...
    whyIntro: 'స్పష్టమైన బుకింగ్‌ల కోసం దొమ్మేరు ఆఫీస్ — అనామక మార్కెట్‌ప్లేస్ కాదు.',
    why1Title: 'స్థానిక ఆఫీస్ డెస్క్',
    why1Body: 'బుకింగ్ సహాయం కోసం దొమ్మేరు ఆఫీస్‌తో మాట్లాడండి — అనామక లిస్టింగ్ కాదు.',
    why2Title: 'లొకేషన్ ఆధారిత మ్యాచింగ్',
    why2Body: 'పికప్ దగ్గర లారీలతో ఓపెన్ లోడ్లను జత చేసి వేగంగా డిస్పాచ్ చేస్తాము.',
    why3Title: 'స్పష్టమైన కమ్యూనికేషన్',
    why3Body: 'పికప్, డ్రాప్, సరుకు, కాంటాక్ట్‌లు అసైన్ అయ్యే వరకు ఆఫీస్‌లో ఉంటాయి.',
    why4Title: 'యజమానులు & షిప్పర్‌లు కలిసి',
    why4Body: 'లోడ్ పోస్ట్ చేయండి లేదా లారీ నమోదు చేయండి — ఒకే డెస్క్ రెండు వైపులా సమన్వయం చేస్తుంది.',
    serviceLearn: 'ఇక్కడ ప్రారంభించండి',
