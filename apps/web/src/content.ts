...
const dict = {
  en: {
    ...
    liveBoardTitle: 'Live availability',
    liveBoardIntro: 'See open loads waiting for vehicles and lorries ready for assignment right now.',
    liveLorriesTitle: 'Available lorries',
    liveLoadsTitle: 'Open load requests',
  ...
  te: {
    ...
    liveBoardTitle: 'ప్రస్తుత అందుబాటు',
    liveBoardIntro: 'వాహనం కోసం వేచి ఉన్న లోడ్లు మరియు అసైన్‌మెంట్‌కు సిద్ధంగా ఉన్న లారీలు ఇప్పుడు చూడండి.',
    liveLorriesTitle: 'అందుబాటులో లారీలు',
    liveLoadsTitle: 'ఓపెన్ లోడ్ అభ్యర్థనలు',
