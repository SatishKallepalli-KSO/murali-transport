...
const dict = {
  en: {
    ...
    tabVisits: 'Visits',
    visitsTitle: 'Website visits',
    visitsHint: 'Privacy-safe totals for the last 14 days. No IP addresses are stored.',
    visitsToday: 'Today',
    visitsHits: 'Page views',
    visitsUniques: 'Unique visitors',
    visitsPeriod: 'Last 14 days',
    visitsDaily: 'Daily trend',
    visitsGeo: 'Locations',
    visitsCountry: 'Country',
    visitsCity: 'City',
    visitsUnknown: 'Unknown',
    visitsEmpty: 'No visit data yet. Numbers appear as people open the public site.',
    visitsPrivacyNote: 'Location uses network country/city headers only when available.',
    ...
    footerPayCommission: 'Pay office commission',
    ...
    privacyS1Body:
      'When you use our booking forms we may collect your name, phone number, pickup and drop locations, cargo details, vehicle plate and capacity, and any notes you provide. Calls and WhatsApp messages to the office numbers may also include contact details you choose to share. The site also records lightweight visit counts (page views and approximate country/city from the network) without storing your IP address.',
    ...
    wxStorm: 'Storm',
    wxFog: 'Haze',
    payPhonePeKicker: 'Office commission · PhonePe',
    payPhonePeTitle: 'Pay office commission',
    payPhonePeBody:
      'Pay only the Dommeru office commission here. Trip / freight money is paid directly to the vehicle owner — not through this payment.',
    payAmountLabel: 'Commission amount (₹)',
    payAmountPh: 'e.g. 200',
    payPhonePeBtn: 'Pay commission on PhonePe',
    payCopyUpi: 'Copy UPI ID',
    payCopied: 'UPI copied',
    payQrAlt: 'PhonePe UPI QR for office commission',
    payQrHint: 'Scan to pay office commission only',
    langEn: 'EN',
    langTe: 'తెలుగు',
  },
  te: {
    ...
    tabVisits: 'సందర్శనలు',
    visitsTitle: 'వెబ్‌సైట్ సందర్శనలు',
    visitsHint: 'గత 14 రోజుల గణాంకాలు. IP చిరునామాలు నిల్వ చేయబడవు.',
    visitsToday: 'ఈరోజు',
    visitsHits: 'పేజీ వీక్షణలు',
    visitsUniques: 'ప్రత్యేక సందర్శకులు',
    visitsPeriod: 'గత 14 రోజులు',
    visitsDaily: 'రోజువారీ ధోరణి',
    visitsGeo: 'స్థానాలు',
    visitsCountry: 'దేశం',
    visitsCity: 'నగరం',
    visitsUnknown: 'తెలియదు',
    visitsEmpty: 'ఇంకా సందర్శన డేటా లేదు. పబ్లిక్ సైట్ తెరిచినప్పుడు సంఖ్యలు కనిపిస్తాయి.',
    visitsPrivacyNote: 'స్థానం అందుబాటులో ఉన్నప్పుడు నెట్‌వర్క్ దేశం/నగరం హెడర్‌ల నుంచి మాత్రమే.',
    ...
    footerPayCommission: 'ఆఫీస్ కమీషన్ చెల్లించండి',
    ...
    privacyS1Body:
      'బుకింగ్ ఫారమ్‌ల ద్వారా మీ పేరు, ఫోన్, పికప్/డ్రాప్, సరుకు వివరాలు, వాహన నంబర్/సామర్థ్యం మరియు మీరు ఇచ్చే గమనికలు సేకరించవచ్చు. ఆఫీస్ ఫోన్/వాట్సాప్ సంభాషణల్లో మీరు పంచుకున్న వివరాలు కూడా ఉండవచ్చు. సైట్ తేలికపాటి సందర్శన గణాంకాలు (పేజీ వీక్షణలు, అంచనా దేశం/నగరం) కూడా నమోదు చేస్తుంది — IP చిరునామా నిల్వ చేయబడదు.',
    ...
    wxStorm: 'తుఫాను',
    wxFog: 'పొగమంచు',
    payPhonePeKicker: 'ఆఫీస్ కమీషన్ · PhonePe',
    payPhonePeTitle: 'ఆఫీస్ కమీషన్ చెల్లించండి',
    payPhonePeBody:
      'ఇక్కడ దొమ్మేరు ఆఫీస్ కమీషన్ మాత్రమే చెల్లించండి. ట్రిప్ / సరుకు డబ్బు నేరుగా వాహన యజమానికి చెల్లించాలి — ఈ చెల్లింపు ద్వారా కాదు.',
    payAmountLabel: 'కమీషన్ మొత్తం (₹)',
    payAmountPh: 'ఉదా. 200',
    payPhonePeBtn: 'PhonePe లో కమీషన్ చెల్లించు',
    payCopyUpi: 'UPI ID కాపీ',
    payCopied: 'UPI కాపీ అయింది',
    payQrAlt: 'ఆఫీస్ కమీషన్ PhonePe UPI QR',
    payQrHint: 'ఆఫీస్ కమీషన్ మాత్రమే స్కాన్ చేసి చెల్లించండి',
    langEn: 'EN',
    langTe: 'తెలుగు',
  },
} as const
